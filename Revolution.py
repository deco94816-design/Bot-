...
# ========== CONFIGURATION ==========
API_ID = 34724923  # Get from https://my.telegram.org
API_HASH = "d46f75f6dbb93156f5bd5284b5fef860"  # Get from https://my.telegram.org
PHONE_NUMBER = "447552437615"  # Your phone number
    ...
    try:
        ...
        if game.current_round < game.total_rounds:
            ...
            await client.send_message(
                ...
                f"👤 {game.username}: {' + '.join(map(str, user_round_results))} = **{user_round_total}**\n"
                f"🤖 Bot: {' + '.join(map(str, bot_round_results))} = **{bot_round_total}**\n\n"
                f"{round_result}\n\n"
